...
<head>
    ...
    <title>Asistencia no confirmada — Sistema gestor de asistencia</title>
</head>
...
<body>
    ...
    <div class="formulario">
        ...
        <div class="form-box" style="text-align: center;">
            ...
            <h2 style="color: #c00000; font-size: 24px; margin-bottom: 20px;">
                Indicaste que no asistirás
            </h2>

            <p style="font-size: 16px; line-height: 1.7; color: #333; margin-bottom: 14px;">
                Si cambias de opinión, acércate al departamento de
                <strong>Control Escolar</strong> de tu facultad.
            </p>

            <a href="index" style="display: inline-block; margin-top: 20px; color: #1f4f8f; font-weight: bold; text-decoration: none;">
