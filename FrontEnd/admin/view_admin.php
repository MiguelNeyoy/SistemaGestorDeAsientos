            ...
            <div id="dashboardView">
                    ...
                    <div class="container-fluid px-4 py-2">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <button id="btnEscanearQR" class="btn btn-primary btn-sm"><i
                                    ...
                                    QR</span></button>
                            <button id="btnEnviarCorreos" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#enviarQRModal"><i class="bi bi-envelope-paper me-1"></i><span class="d-none d-md-inline">Enviar QRs</span></button>
                ...
                <div class="container-fluid px-4 pb-5">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h3 class=" m-0 fw-light"><i class="bi bi-bar-chart-fill me-2 text-primary"></i>Resumen del Evento
                        </h3>
                    ...
                    <div class="card shadow rounded-3 mb-4"
                        ...
                        <div class="card-body p-0" id="directorioCardBody">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-hover m-0 align-middle text-nowrap"
                                    id="alumnosTable">
                                    ...
                                    <tbody id="alumnosTableBody" style="color: #334155; font-size: 0.95rem;">
                                        <tr>
                                            <td colspan="8" class="text-center py-4 text-muted">
                                                <div class="spinner-border spinner-border-sm me-2 text-primary"
                                                    role="status">
                                                </div>
