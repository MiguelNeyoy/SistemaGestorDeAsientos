...
<body>
    ...
    <div class="container">
        <div class="form-box">
        <strong><h1 class="titulo-escuela">Facultad de informática</h1></strong>
        <h2 class="subtitulo">Confirmación de asistencia</h2>
       

        <div class="alert alert-info mt-3">
            Ingresa tu número de cuenta <strong>sin el último dígito</strong>. En caso de no tenerlo, solicítalo en ventanilla con control escolar.
        </div>
