...
<body>
    ...
    <?php if (!$tieneSesion): ?>
        <div id="loginView" class="container mt-5" style="max-width: 450px;">
            ...
            <?php if ($error != ""): ?>
                <div id="loginError" class="alert alert-danger text-center shadow-sm"><?php echo htmlspecialchars($error); ?>
                </div>
                <?php
            endif; ?>
            ...
            <form id="loginForm" method="POST" action="">
                <div style="position: relative; margin-top: 15px;">
                    <i class="bi bi-person"
                        style="position: absolute; left: 15px; top: 50%; transform: translateY(-50%); color: #555; font-size: 1.2rem;"></i>
                    <input type="text" name="usuario" id="adminUser" placeholder="Usuario" required
                        style="padding-left: 45px; margin-top: 0; box-shadow: none;">
                </div>
                <div style="position: relative; margin-top: 15px;">
                    <i class="bi bi-key"
                        style="position: absolute; left: 15px; top: 50%; transform: translateY(-50%); color: #555; font-size: 1.2rem;"></i>
                    <input type="password" name="contrasena" id="adminPass" placeholder="Contraseña" required
                        style="padding-left: 45px; margin-top: 0; box-shadow: none;">
                </div>
        ...
        <div id="dashboardView">
            ...
            <nav class="navbar navbar-light mb-4 shadow-sm"
                style="background-color: #ffffff; border-bottom: 2px solid #e2e8f0;">
                    ...
                    <div class="col-6 col-md-4 col-lg-2">
                        <div class="card metric-card text-white bg-danger h-100" onclick="setFilterType('INF')"
                            ...
                            <div class="card-body text-center d-flex flex-column justify-content-center">
                                ...
                                <h6 class="card-title text-uppercase fw-bold mb-1" style="font-size: 0.8rem;">Informática
                                </h6>
                    ...
                    <div class="col-6 col-md-4 col-lg-2">
                        <div class="card metric-card bg-dark h-100" onclick="setFilterType('RECHAZADOS')"
                            ...
                            <div class="card-body text-center d-flex flex-column justify-content-center">
                                ...
                                <h6 class="card-title text-uppercase fw-bold mb-1" style="font-size: 0.8rem;">No Asistirán
                                </h6>
                ...
                <div class="card shadow rounded-3 mb-4"
                    ...
                    <div class="card-header p-3 d-flex flex-wrap justify-content-between align-items-center gap-3"
                        ...
                        <h5 class="m-0 fw-bold" style="color: #334155;"><i
                                class="bi bi-list-check me-2 text-primary"></i>Directorio de Asistencia</h5>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title" id="editarAlumnoModalLabel"><i class="bi bi-pencil-square me-2"></i>Editar
                            Alumno</h5>
                    ...
                    <form id="formEditarAlumno">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" id="btnGuardarEdicion">
                                <span class="spinner-border spinner-border-sm d-none me-2" id="spinnerEdit" role="status"
